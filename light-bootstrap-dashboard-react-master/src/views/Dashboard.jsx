...
class Dashboard extends Component {
  ...
  fetchMessageList(deviceParam, severityParam){
    ...
    if(sParam == undefined)
       sParam = '';
    fetch("http://52.42.194.161:3306/messages?deviceName="+dParam+"&severity="+sParam, {
	       headers:{
  ...
  fetchDeviceStatistics(deviceParam){
    ...
    if(deviceName==undefined)
       deviceName=''
    fetch("http://52.42.194.161:3306/device/stats?deviceName="+deviceName,{
	       headers:{
			   authorization: this.state.accessToken
           }			   
	   })
  ...
  fetchMessageStatistics(deviceParam, sevParam){
    ...
    fetch("http://52.42.194.161:3306/message/stats?deviceName="+dParam+"&severity="+sParam,{
	       headers:{
			   authorization: this.state.accessToken
           }			   
	   })
